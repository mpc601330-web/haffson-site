...
<a class="button button-primary" href="#waitlist">Quiero dejar de perseguir cobros</a>
...
## Esto sale de dolor real

No es una idea bonita.

Nace de equipos que siguen persiguiendo pagos con correo, hojas y memoria.
...
<form id="waitlist" class="waitlist-form" data-source="/es/seguimiento-facturas-clientes/">
  <input type="email" class="email-input" placeholder="Tu email de trabajo" required />
  <button type="submit">Acceder antes</button>
</form>
...
<a class="button button-primary" href="#waitlist">Reservar acceso temprano</a>
